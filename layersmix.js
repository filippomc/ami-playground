...
const HelpersStack = AMI.stackHelperFactory(THREE);
...
const HelpersLocalizer = AMI.localizerHelperFactory(THREE);

const LoadersVolume = AMI.VolumeLoader;

const ShadersUniform = AMI.DataUniformShader
const ShadersVertex = AMI.DataVertexShader
const ShadersFragment = AMI.DataFragmentShader
const ShadersLayerUniform = AMI.LayerUniformShader
const ShadersLayerVertex = AMI.LayerVertexShader
const ShadersLayerFragment = AMI.LayerFragmentShader
